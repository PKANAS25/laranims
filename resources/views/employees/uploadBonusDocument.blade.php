...
<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right hidden-print">
				...
				<li class="active"><a href="javascript:;">Bonus Document</a></li>
				 
			</ol> 
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header hidden-print">Upload <small> Bonus Document</small></h1>
			<!-- end page-header -->
			<!-- begin row -->
			 <div class="col-md-12">
                    <!-- begin panel -->
                    <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                        <div class="panel-heading hidden-print">
                            ...
                            <h4 class="panel-title">Bonus Document</h4>
                        </div>
