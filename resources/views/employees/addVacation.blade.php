...
<div id="content" class="content">
            ...
            <ol class="breadcrumb pull-right hidden-print">
                ...
                <li class="active"><a href="javascript:;">Add Vacation</a></li>
                 
            </ol> 
            <!-- end breadcrumb -->
            <!-- begin page-header -->
            <h1 class="page-header hidden-print">Add <small> Vacation</small></h1>
            <!-- end page-header -->
            <!-- begin row -->
             <div class="col-md-12">
                    <!-- begin panel -->
                            ...
                            <a href="{{ action('EmployeesController@profile',base64_encode($employee->employee_id)) }}"><i class="fa fa-arrow-left"></i> Back to Employee Profile</a>   
                              ...
                              <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" id="starter" name="starter" data-fv-notempty="true" value="{{ old('starter') }}" data-fv-remote="true"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" id="ender" name="ender" data-fv-notempty="true" value="{{ old('ender') }}" data-fv-remote="true"/>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="radio-inline">
                                            <label>
                                                <input type="radio" name="paid" value="1" id="radio-required" data-fv-notempty="true" /> With Salary
                                                </label>
                                        </div>

                                        <div class="radio-inline">
                                            <label>
                                                <input type="radio" name="paid" value="-1" id="radio-required" data-fv-notempty="true" /> By Cheque(Prepaid)
                                            </label>
                                        </div>

                                        <div class="radio-inline">
                                            <label>
                                               <input type="radio" name="paid" value="0" id="radio-required" data-fv-notempty="true" /> No Payment
                                            </label>
                                        </div>
                                    </div>
                                </div> 
