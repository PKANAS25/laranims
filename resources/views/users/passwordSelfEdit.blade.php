...
<div id="content" class="content">
    ...
    data-fv-icon-validating="glyphicon glyphicon-refresh">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-4" for="password">Current Password :</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="password"  name="current_password"   data-fv-notempty="true"   />
                                    </div>
                                </div>
                                  

                                <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-4" for="password">New Password :</label>
                                    <div class="col-md-6 col-sm-6">
                               ...
                               <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-4" for="password_confirmation">Confirm New Password :</label>
                                    <div class="col-md-6 col-sm-6">
