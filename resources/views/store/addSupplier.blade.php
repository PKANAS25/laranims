...
<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right hidden-print">
				...
				<li class="active"><a href="javascript:;">Add Supplier</a></li>
				 
			</ol> 
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header hidden-print">Store <small> Add Supplier</small></h1>
			<!-- end page-header -->
			<!-- begin row -->
			 <div class="col-md-12">
                    <!-- begin panel -->
                        ...
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" id="name" name="name" data-fv-notempty="true"  data-fv-remote="true"  value="{{ old('name') }}" />  
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" id="mob1" name="mob1"   data-fv-notempty="true"  value="{{ old('mob1') }}" />  
                                    </div>
                                </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text"   id="ofc1" name="ofc1"   data-fv-notempty="true" value="{{ old('ofc1') }}" />  
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" id="email"   name="email" data-fv-emailaddress="true"   value="{{ old('email') }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" id="contact_person"   name="contact_person" data-fv-notempty="true"    value="{{ old('contact_person') }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" id="mob2"   name="mob2"    value="{{ old('mob2') }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" id="ofc2"   name="ofc2"    value="{{ old('ofc2') }}" />
                                    </div>
                                </div>
